...
import { ArrowLeft, ArrowRight, Award, BookOpen, Clock, Users, Check, GraduationCap, Globe, Quote } from "lucide-react";
...
export default function DigitalLiteracyCoursePage() {
    const courseData = {
        ...
        heroImage: "/digital-literacy-hero.jpg",
        heroTagline: "Essential Computing Skills for the Digital Age",
        heroDescription: "Gain the fundamental computing skills needed to succeed in academic, professional, and personal settings with the globally recognized IC3 certification.",
        overview: "The IC3 Digital Literacy Certification course covers essential computing concepts, key applications, and living online. This globally recognized certification validates your ability to use computers effectively in various settings. You'll learn computer basics, internet usage, email management, digital citizenship, and online safety. This is the perfect foundation for anyone starting their digital journey or preparing for more advanced IT courses.",
        learningObjectives: [
            "Understand computer hardware and software basics",
            "Master operating system fundamentals",
            "Use productivity applications effectively",
            "Navigate the internet safely and efficiently",
            "Manage email and digital communication",
            "Understand digital citizenship and online safety",
            "Identify and avoid common online threats",
            "Use computers for academic and professional tasks"
        ],
        curriculum: [
            {
                week: "Week 1: Computing Fundamentals",
                topics: [
            ...
            {
                week: "Week 2: Key Applications",
                topics: [
                    "Word processing software basics",
                    "Spreadsheet software fundamentals",
                    "Presentation software overview",
                    "Database concepts",
                    "Productivity software for academic and business use"
                ]
            },
            {
                week: "Week 3: Living Online",
                topics: [
            ...
            {
                week: "Week 4: Digital Citizenship & Safety",
                topics: [
                    "Online safety and security best practices",
                    "Identifying and avoiding scams and phishing",
                    "Digital citizenship and ethical online behavior",
        ...
        certificationDetails: {
            ...
            examCode: "IC3-GS5",
            validity: "Lifetime",
            recognition: "Globally recognized standard for digital literacy",
            examFormat: "45 questions, 45 minutes",
            passingScore: "70%"
        },
        targetAudience: [
            "Students beginning their digital education",
            "Professionals needing foundational computer skills",
            "Job seekers preparing for office positions",
            "Seniors learning to use computers",
            "Anyone wanting to validate their digital skills",
            "Individuals preparing for more advanced IT courses"
        ],
        prerequisites: [
        ...
        careerOutcomes: [
            "Office Assistant", "Administrative Support", "Data Entry Clerk", "Customer Service Representative", "General Office Worker", "Student"
        ],
        testimonial: {
            quote: "The Digital Literacy course at Ykay IT Hub gave me the confidence to use computers effectively in my daily work. I now understand how to navigate the digital world safely and efficiently.",
            name: "Student H",
            originalName: "Amina Lawal",
            ...
            <main className="bg-[var(--bg-primary)] min-h-screen theme-transition">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-white/70 text-lg font-body mb-8">Earn the IC3 Digital Literacy Certification, the global standard for validating essential computing skills.</p>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12">
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)] mb-8">This course is perfect for anyone starting their digital journey.</p>
                                <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)] mb-8">No prior experience required for this foundation course.</p>
                                <div className="space-y-4">
                ...
                <section className="py-20 px-6 bg-[var(--section-bg-alt)]">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Completing this course provides the foundation for various entry-level career opportunities.</p>
                        ...
                        <div className="bg-brand-navy rounded-3xl p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden">
                                    <img src="/testimonial-digital-literacy.jpg" alt={courseData.testimonial.originalName} className="w-full h-full object-cover" />
                                </div>
                ...
                <section className="py-20 px-6">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <p className="text-[var(--text-secondary)] text-center mb-12 max-w-2xl mx-auto">Explore other IT courses to continue your learning journey</p>
                ...
                <section id="register" className="py-20 px-6 bg-brand-navy">
                    <div className="mx-auto max-w-4xl">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl text-white mb-4">Ready to Start Your <span className="text-brand-green">Digital Journey?</span></h2>
