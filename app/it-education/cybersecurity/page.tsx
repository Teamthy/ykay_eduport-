...
import { ArrowLeft, ArrowRight, Award, BookOpen, Clock, Users, Check, GraduationCap, Shield, Quote } from "lucide-react";
...
export default function CybersecurityCoursePage() {
    const courseData = {
        ...
        heroImage: "/cybersecurity-hero.jpg",
        heroTagline: "Protect Systems and Data from Cyber Threats",
        heroDescription: "Learn the fundamentals of cybersecurity, threat detection, risk management, and security protocols to protect information systems.",
        overview: "This cybersecurity course covers network security fundamentals, threat detection, risk management, and security protocols. Students will learn about encryption, firewalls, ethical hacking basics, and how to implement security best practices. The IT Specialist – Cybersecurity certification is globally recognized and validates your ability to protect information systems from cyber threats.",
        learningObjectives: [
            ...
            "Work with encryption and cryptography basics",
            "Configure and manage firewalls and intrusion detection systems",
            "Understand ethical hacking and penetration testing basics",
            "Develop risk management and security policy strategies",
            "Respond to security incidents and breaches"
        ],
        curriculum: [
            {
                week: "Week 1-2: Cybersecurity Fundamentals",
                topics: [
            ...
            {
                week: "Week 3-4: Network Security",
                topics: [
            ...
            {
                week: "Week 5: Cryptography & Access Control",
                topics: [
                    "Encryption algorithms and protocols",
                    "Public Key Infrastructure (PKI)",
                    "Authentication and authorization mechanisms",
                    "Access control models and implementations",
                    "Password security and management"
                ]
            },
            {
                week: "Week 6: Threat Detection & Response",
                topics: [
                    "Threat intelligence and monitoring",
                    "Incident response procedures",
                    "Digital forensics basics",
                    "Security auditing and testing",
                    "Certification exam preparation and practice tests"
                ]
            }
        ],
        ...
        targetAudience: [
            ...
            "Network administrators wanting to enhance security skills",
            ...
            "Professionals wanting to understand security best practices"
        ],
        prerequisites: [
        ...
        careerOutcomes: [
            "Cybersecurity Analyst", "Security Engineer", "Network Security Specialist", "Information Security Officer", "Security Consultant", "Ethical Hacker"
        ],
        testimonial: {
            quote: "The cybersecurity course at Ykay IT Hub gave me a solid foundation in protecting systems from threats. I now feel confident in identifying vulnerabilities and implementing security measures.",
            name: "Student C",
            originalName: "Michael Adewale",
            ...
            <main className="bg-[var(--bg-primary)] min-h-screen theme-transition">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-white/70 text-lg font-body mb-8">Earn a globally recognized certification that validates your cybersecurity skills and boosts your career prospects.</p>
                ...
                <section className="py-20 px-6 bg-[var(--section-bg-alt)]">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Completing this course opens doors to various career opportunities in the cybersecurity industry.</p>
                        ...
                        <div className="bg-brand-navy rounded-3xl p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden">
                                    <img src="/testimonial-cybersecurity.jpg" alt={courseData.testimonial.originalName} className="w-full h-full object-cover" />
                                </div>
                ...
                <section id="register" className="py-20 px-6 bg-brand-navy">
                    <div className="mx-auto max-w-4xl">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl text-white mb-4">Ready to Start Your <span className="text-brand-green">Cybersecurity Journey?</span></h2>
