...
import { ArrowLeft, ArrowRight, Award, BookOpen, Clock, Users, Check, GraduationCap, Cpu, Brain, Quote } from "lucide-react";
...
export default function AICoursePage() {
    const courseData = {
        ...
        shortTitle: "AI",
        certification: "IT Specialist – Artificial Intelligence",
        category: "Programming & AI",
        duration: "10 Weeks",
        difficulty: "Intermediate",
        price: "₦200,000",
        discountPrice: "₦170,000",
        heroImage: "/ai-hero.jpg",
        heroTagline: "Unlock the Future of Technology",
        heroDescription: "Dive into the fascinating world of AI, machine learning, and neural networks. Gain the knowledge and skills to build intelligent systems.",
        overview: "This Artificial Intelligence course provides a comprehensive introduction to AI concepts, machine learning algorithms, neural networks, and practical applications. You'll learn how to implement AI solutions, work with popular AI frameworks, and understand the ethical implications of AI technology. The course prepares you for the IT Specialist – Artificial Intelligence certification, validating your AI knowledge and skills.",
        learningObjectives: [
        ...
        curriculum: [
            ...
            {
                week: "Week 3-5: Machine Learning",
                topics: [
            ...
            {
                week: "Week 6-7: Neural Networks & Deep Learning",
                topics: [
            ...
            {
                week: "Week 8-10: AI Applications & Projects",
                topics: [
                    "Natural Language Processing (NLP) basics",
                    "Computer Vision fundamentals",
                    "AI ethics and bias in AI systems",
        ...
        targetAudience: [
            ...
            "Data scientists looking to expand their knowledge",
            "Professionals in any field interested in AI applications",
            "Researchers exploring AI technologies",
            "Entrepreneurs planning AI-based startups"
        ],
        prerequisites: [
            "Basic Python programming knowledge",
            "Understanding of algorithms and data structures",
            "Familiarity with mathematics (algebra, statistics)",
            "Willingness to learn complex concepts"
        ],
        careerOutcomes: [
            "AI Engineer", "Machine Learning Engineer", "Data Scientist", "AI Researcher", "AI Product Manager", "AI Consultant"
        ],
        testimonial: {
            quote: "The AI course at Ykay IT Hub opened my eyes to the incredible possibilities of artificial intelligence. The practical projects helped me understand how to apply AI in real-world scenarios.",
            name: "Student A",
            originalName: "Kuton Dagbeyon Olamide",
            role: "AI Enthusiast"
        },
        relatedCourses: [
            { title: "Python Programming", href: "/it-education/python" },
            { title: "Microsoft Excel", href: "/it-education/microsoft-excel" },
            { title: "Cybersecurity", href: "/it-education/cybersecurity" }
        ]
    };
            ...
            <main className="bg-[var(--bg-primary)] min-h-screen theme-transition">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10">
                                    <img src={courseData.heroImage} alt={courseData.title} className="w-full h-96 object-cover" />
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-white/70 text-lg font-body mb-8">Earn a globally recognized certification that validates your AI knowledge and boosts your career prospects.</p>
                ...
                <section className="py-20 px-6 bg-[var(--section-bg-alt)]">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Completing this course opens doors to various career opportunities in the AI industry.</p>
                        ...
                        <div className="bg-brand-navy rounded-3xl p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden">
                                    <img src="/testimonial-ai.jpg" alt={courseData.testimonial.originalName} className="w-full h-full object-cover" />
                                </div>
                ...
                <section id="register" className="py-20 px-6 bg-brand-navy">
                    <div className="mx-auto max-w-4xl">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl text-white mb-4">Ready to Start Your <span className="text-brand-green">AI Journey?</span></h2>
