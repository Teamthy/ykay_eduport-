...
import { ArrowLeft, ArrowRight, Award, BookOpen, Clock, Users, Check, GraduationCap, FileText, Quote } from "lucide-react";
import Header from "@/components/Header";
import Footer from "@/components/Footer";

export default function MicrosoftWordCoursePage() {
    const courseData = {
        ...
        heroImage: "/microsoft-word-hero.jpg",
        heroTagline: "Create Professional Documents with Ease",
        heroDescription: "Master Microsoft Word for creating professional documents, reports, and publications with advanced formatting and collaboration features.",
        overview: "This comprehensive Microsoft Word course will transform you into a document creation expert. You'll learn to create, format, and manage professional documents efficiently. From basic text editing to advanced features like mail merge, styles, and templates, this course covers everything you need to become proficient in Microsoft Word. Prepare for the Microsoft Office Specialist certification and validate your document creation skills.",
        learningObjectives: [
            "Create and format professional documents",
            "Master text formatting and styles",
            "Work with tables, images, and graphics",
            "Use templates and themes effectively",
            "Implement mail merge for personalized documents",
        ...
        curriculum: [
            ...
            {
                week: "Week 2: Document Formatting",
                topics: [
                    "Working with styles and themes",
                    "Creating and modifying lists",
                    "Applying borders and shading",
                    "Using tabs and indentation",
                    "Page layout and margins"
                ]
            },
            {
                week: "Week 3: Advanced Features",
                topics: [
            ...
            {
                week: "Week 4: Collaboration & Automation",
                topics: [
        ...
        targetAudience: [
            "Students and professionals needing document skills",
            "Administrative assistants and secretaries",
            "Content creators and writers",
            "Anyone preparing for office jobs",
        ...
        careerOutcomes: [
            "Administrative Assistant", "Office Manager", "Document Specialist", "Content Writer", "Executive Assistant", "Data Entry Clerk"
        ],
        testimonial: {
            quote: "The Microsoft Word course at Ykay IT Hub has made my document creation process so much faster and more professional. I can now create complex documents with ease.",
            name: "Student D",
            originalName: "Fatima Musa",
            role: "Administrative Officer"
        },
        relatedCourses: [
            { title: "Microsoft Excel", href: "/it-education/microsoft-excel" },
            { title: "Microsoft PowerPoint", href: "/it-education/microsoft-powerpoint" },
            ...
            <main className="bg-[var(--bg-primary)] min-h-screen theme-transition">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-white/70 text-lg font-body mb-8">Earn the Microsoft Office Specialist certification, recognized globally as the standard for document creation skills.</p>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12">
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)] mb-8">This course is perfect for anyone who needs to create professional documents.</p>
                                <div className="space-y-4">
                ...
                <section className="py-20 px-6 bg-[var(--section-bg-alt)]">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Completing this course opens doors to various administrative and office career opportunities.</p>
                        ...
                        <div className="bg-brand-navy rounded-3xl p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden">
                                    <img src="/testimonial-word.jpg" alt={courseData.testimonial.originalName} className="w-full h-full object-cover" />
                                </div>
                ...
                <section id="register" className="py-20 px-6 bg-brand-navy">
                    <div className="mx-auto max-w-4xl">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl text-white mb-4">Ready to Master <span className="text-brand-green">Microsoft Word?</span></h2>
