...
import { ArrowLeft, ArrowRight, Award, BookOpen, Clock, Users, Check, GraduationCap, Code, Quote } from "lucide-react";
...
export default function PythonCoursePage() {
    const courseData = {
        ...
        heroDescription: "From basics to advanced Python development, gain the skills needed to build real-world applications and earn your IT Specialist certification.",
        overview: "This comprehensive Python programming course is designed to take you from a complete beginner to a confident Python developer. You'll learn Python syntax, data structures, algorithms, object-oriented programming, and how to build real-world applications. The course prepares you for the IT Specialist – Python certification exam, a globally recognized credential that validates your Python programming skills.",
        learningObjectives: [
            ...
            "Build web applications with Flask basics",
            "Work with databases and SQL in Python",
            "Create and use functions, modules, and packages",
            "Implement algorithms and problem-solving techniques"
        ],
        curriculum: [
            {
                week: "Week 1-2: Python Fundamentals",
                topics: ["Introduction to Python and development environment setup", "Variables, data types, and operators", "Control flow (if/else, loops, comprehensions)", "Functions and modules", "Basic input/output operations"]
            },
            {
                week: "Week 3-4: Data Structures & Error Handling",
                topics: ["Lists, tuples, and dictionaries in depth", "Sets and their operations", "List comprehensions and generator expressions", "Working with strings and text processing", "Error handling with try/except/finally"]
            },
            {
                week: "Week 5-6: Object-Oriented Programming",
                topics: ["Classes and objects fundamentals", "Inheritance and polymorphism", "Encapsulation and abstraction", "Magic methods and operator overloading", "Working with files and directories"]
            },
            {
                week: "Week 7-8: Advanced Topics & Projects",
                topics: ["Working with databases (SQLite, MySQL)", "Introduction to web frameworks (Flask)", "API development basics", "Building a complete project", "Certification exam preparation and practice tests"]
            }
        ],
        certificationDetails: {
            ...
            examCode: "ITSP-PY100",
            validity: "Lifetime",
            recognition: "Globally recognized by employers and educational institutions",
            examFormat: "60 multiple-choice questions, 50 minutes",
            passingScore: "70%"
        },
        targetAudience: [
            ...
            "Anyone preparing for the IT Specialist – Python certification",
            "Data analysts and scientists needing Python skills"
        ],
        prerequisites: [
        ...
        careerOutcomes: [
            "Python Developer", "Backend Developer", "Data Analyst", "Automation Engineer", "Software Engineer", "DevOps Engineer"
        ],
        testimonial: {
            quote: "The Python certification course at Ykay IT Hub gave me the confidence and skills to start my career as a software developer. The hands-on projects were invaluable.",
            name: "Student P",
            originalName: "Akinbode Oluwajoba Emmanuel",
            role: "Junior Python Developer"
        },
        relatedCourses: [
            { title: "Artificial Intelligence", href: "/it-education/ai" },
            ...
            <main className="bg-[var(--bg-primary)] min-h-screen theme-transition">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-white/70 text-lg font-body mb-8">Earn a globally recognized certification that validates your Python skills and boosts your career prospects.</p>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12">
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)] mb-8">This course is perfect for individuals at various stages of their learning journey.</p>
                                <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)] mb-8">No prior experience is required for this course.</p>
                                <div className="space-y-4">
                ...
                <section className="py-20 px-6 bg-[var(--section-bg-alt)]">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Completing this course opens doors to various career opportunities in the tech industry.</p>
                        ...
                        <div className="bg-brand-navy rounded-3xl p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden">
                                    <img src="/testimonial-python.jpg" alt={courseData.testimonial.originalName} className="w-full h-full object-cover" />
                                </div>
                ...
                <section className="py-20 px-6">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <p className="text-[var(--text-secondary)] text-center mb-12 max-w-2xl mx-auto">Explore other courses that might interest you</p>
                ...
                <section id="register" className="py-20 px-6 bg-brand-navy">
                    <div className="mx-auto max-w-4xl">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl text-white mb-4">Ready to Start Your <span className="text-brand-green">Python Journey?</span></h2>
