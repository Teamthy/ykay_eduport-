...
export default function MicrosoftExcelCoursePage() {
    const courseData = {
        ...
        heroImage: "/microsoft-excel-hero.jpg",
        heroTagline: "Master Data Analysis and Spreadsheet Management",
        heroDescription: "Develop expertise in Microsoft Excel for data analysis, financial modeling, and business intelligence. Learn functions, formulas, and data visualization.",
        overview: "This comprehensive Microsoft Excel course will transform you into a data analysis expert. You'll learn to create, manage, and analyze data efficiently using Excel's powerful features. From basic spreadsheets to advanced functions, pivot tables, and data visualization, this course covers everything you need to become proficient in Microsoft Excel. Prepare for the Microsoft Office Specialist certification and validate your spreadsheet skills.",
        learningObjectives: [
            ...
            "Use conditional formatting for data analysis",
            "Implement data validation and protection"
        ],
        curriculum: [
            {
                week: "Week 1: Excel Fundamentals",
                topics: [
                    "Introduction to Excel interface and workbook structure",
            ...
            {
                week: "Week 2: Functions & Data Management",
                topics: [
            ...
            {
                week: "Week 3: Advanced Functions & Analysis",
                topics: [
            ...
            {
                week: "Week 5: Advanced Features & Automation",
                topics: [
        ...
        targetAudience: [
            ...
            "Anyone preparing for office jobs requiring Excel"
        ],
        prerequisites: [
        ...
        careerOutcomes: [
            "Data Analyst", "Financial Analyst", "Accountant", "Business Analyst", "Reporting Specialist", "Administrative Assistant"
        ],
        testimonial: {
            quote: "The Excel course at Ykay IT Hub has completely changed how I work with data. I can now create complex reports and analyze information much faster than before.",
            name: "Student E",
            originalName: "Chinwe Okoro",
        ...
        relatedCourses: [
            ...
            { title: "Excel Expert", href: "/it-education/excel-expert" }
        ]
    };
            ...
            <main className="bg-[var(--bg-primary)] min-h-screen theme-transition">
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-white/70 text-lg font-body mb-8">Earn the Microsoft Office Specialist certification in Excel, recognized globally as the standard for spreadsheet skills.</p>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid lg:grid-cols-2 gap-12">
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)] mb-8">This course is perfect for anyone who works with data and spreadsheets.</p>
                                <div className="space-y-4">
                ...
                <section className="py-20 px-6 bg-[var(--section-bg-alt)]">
                    <div className="mx-auto max-w-7xl text-center">
                        ...
                        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Completing this course opens doors to various data-focused career opportunities.</p>
                        ...
                        <div className="bg-brand-navy rounded-3xl p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden">
                                    <img src="/testimonial-excel.jpg" alt={courseData.testimonial.originalName} className="w-full h-full object-cover" />
                                </div>
                ...
                <section id="register" className="py-20 px-6 bg-brand-navy">
                    <div className="mx-auto max-w-4xl">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl text-white mb-4">Ready to Master <span className="text-brand-green">Microsoft Excel?</span></h2>
