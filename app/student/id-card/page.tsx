...
import { LayoutDashboard, CalendarDays, FileText, User, Bell, ClipboardCheck, GraduationCap, IdCard, Download, Printer, QrCode, School, Phone, Calendar } from "lucide-react";
          ...
          <div className="mx-auto max-w-7xl flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0 flex flex-col items-center space-y-8">
              ...
              <div className="w-full max-w-md">
                <div className="text-xs text-[var(--text-muted)] uppercase tracking-widest mb-2 text-center">Front</div>
                <div className="rounded-3xl overflow-hidden border-2 border-brand-green/40 shadow-2xl">
                  ...
                  <div className="bg-white p-6 text-center">
                    ...
                    <h2 className="font-display text-2xl text-brand-navy tracking-widest mb-1">EMMANUEL ADEBAYO</h2>
                    <div className="text-xs text-gray-600 mb-3">Student · SS2 B · Science Track</div>
                  ...
                  <div className="bg-brand-green p-3 text-center">
                    <div className="text-white text-[10px] font-bold">
                      <Phone size={10} className="inline mr-1" /> 0701 537 4411 · info@ykaycollege.com
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-md w-full p-4 rounded-2xl bg-brand-orange/10 border border-brand-orange/30 text-center">
                <p className="text-xs text-brand-orange">
                  This is a digital ID card. Physical cards are issued by the school administration. Present this QR code for verification at school events.
                </p>
              </div>
            </div>
          </div>
