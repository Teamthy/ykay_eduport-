                    ...
                    <div className="flex flex-col md:flex-row md:items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-3 mb-2">
                          <div>
                            ...
                            <div className="text-xs text-[var(--text-muted)] mt-1">
                              {e.subject} · Class {e.class}
                            </div>
                          </div>
                          <span
                            className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-widest shrink-0 ${
                              e.status === "Completed"
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 my-4">
                          ...
                          <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
                            <FileText size={12} className="text-brand-green" /> {e.questions}{" "}
                            questions
                          </div>
                          <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-[var(--border-subtle)]">
                          <div className="flex items-center gap-4 text-xs">
                            <span className="flex items-center gap-1 text-[var(--text-muted)]">
                              <Users size={12} />{" "}
                              <strong className="text-[var(--text-primary)]">{e.takers}</strong>{" "}
                              takers
                            </span>
                            {e.avgScore !== null && (
