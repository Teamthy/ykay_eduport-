        ...
        <section className="pt-24 pb-10 bg-brand-navy px-6">
          <div className="mx-auto max-w-7xl">
            ...
            <p className="text-white/60 text-sm">
              Direct communication channels with parents in your form class.
            </p>
          </div>
        </section>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <a
                        ...
                        className="p-2.5 rounded-xl bg-brand-green/10 text-brand-green flex flex-col items-center gap-1 hover:bg-brand-green hover:text-white transition-all"
                      >
                        <Phone size={14} />
                        <span className="text-[9px] font-bold uppercase">Call</span>
                      </a>
                      <a
                        href={`https://wa.me/234${s.parentContact.replace(/\D/g, "").slice(1)}`}
                        target="_blank"
                        rel="noreferrer"
                        className="p-2.5 rounded-xl bg-[#25D366]/10 text-[#25D366] flex flex-col items-center gap-1 hover:bg-[#25D366] hover:text-white transition-all"
                      >
                      ...
                      <button
                        ...
                        className="p-2.5 rounded-xl bg-brand-orange/10 text-brand-orange flex flex-col items-center gap-1 hover:bg-brand-orange hover:text-white transition-all"
                      >
                        <Send size={14} />
