      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-24 md:py-36 w-full">
        <div className="max-w-4xl">
          <motion.p
            ...
            className="font-body text-xs md:text-sm font-bold tracking-[0.25em] uppercase text-white/40 mb-4 md:mb-6"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center gap-6 md:gap-10 text-white/60 font-body text-sm md:text-base"
          >
            <div>
              <span className="block text-xs uppercase tracking-[0.15em] text-white/30">Location</span>
              <span className="font-medium">Sango Ota, Ogun State</span>
            </div>
            <div className="w-px h-8 bg-[#0D0D0D]/15 hidden sm:block" />
            <div>
              <span className="block text-xs uppercase tracking-[0.15em] text-white/30">Programmes</span>
              <span className="font-medium">Junior &amp; Senior Secondary</span>
            </div>
            <div className="w-px h-8 bg-[#0D0D0D]/15 hidden sm:block" />
            <div>
              <span className="block text-xs uppercase tracking-[0.15em] text-white/30">Session</span>
          ...
          >
            <a
              href="/admissions"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#0D0D0D] text-[#0D0D0D] font-body text-sm font-bold tracking-[0.15em] uppercase hover:bg-[#0D0D0D]/90 transition-all duration-300 hover:scale-[1.03] active:scale-[0.97] shadow-lg shadow-white/10"
            >
              Apply for Admission
            </a>
            <a
              href="/portal"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#0D0D0D]/5 text-white border border-white/15 font-body text-sm font-bold tracking-[0.15em] uppercase hover:bg-[#0D0D0D]/10 transition-all duration-300 hover:scale-[1.03] active:scale-[0.97]"
            >
              Student Portal
            </a>
          </motion.div>
