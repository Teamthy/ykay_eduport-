...
export default function About() {
  return (
    <section
      id="about"
      className="w-full bg-[var(--bg-primary)] pt-16 md:pt-24 pb-8 md:pb-12 theme-transition"
    >
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="font-body text-sm md:text-base text-[var(--text-muted)] leading-relaxed mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={tag}
                  className="px-3 py-1.5 rounded-full bg-[var(--surface-card-hover)] border border-[var(--border-subtle)] text-[10px] font-bold tracking-[0.1em] uppercase text-[var(--text-secondary)]"
                >
                  {tag}
                </span>
              ))}
          ...
          >
            ...
            {/* Director Card */}
            <div className="mt-6 bg-[var(--surface-card)] border border-[var(--border-subtle)] rounded-2xl p-6 shadow-[var(--card-shadow)]">
              ...
              <p className="font-body text-xs text-[var(--accent-primary)] font-bold tracking-[0.2em] uppercase mb-3">
                Director &amp; Proprietor — Ykay College
              </p>
              <blockquote className="font-body text-sm text-[var(--text-secondary)] leading-relaxed italic border-l-2 border-[var(--accent-primary)] pl-4">
        ...
        >
          {[
            ...
            <div
              key={card.title}
              className="rounded-[2rem] bg-[var(--surface-card)] border border-[var(--border-subtle)] p-8 md:p-10 shadow-[var(--card-shadow)] hover:border-[var(--card-border-hover)] hover:shadow-[var(--card-shadow-hover)] hover:-translate-y-1 transition-all duration-300"
            >
              <h3 className="font-display text-xl md:text-2xl tracking-[2px] text-[var(--text-primary)] mb-4">
                {card.title}
              </h3>
