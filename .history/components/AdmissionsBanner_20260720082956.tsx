    ...
    <section className="w-full bg-white pt-24 md:pt-32 pb-4 md:pb-8">
      <div className="mx-auto max-w-7xl px-6">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#0C1824] via-[#184B18] to-[#4EC54D] p-10 md:p-16 lg:p-20"
        >
          {/* Decorative circles */}
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            ...
            <a
              href="/admissions"
              className="inline-flex items-center gap-3 self-start lg:self-end px-8 py-4 rounded-full bg-[#FF6E00] text-white font-body text-sm font-bold tracking-[0.15em] uppercase hover:bg-[#E65F00] transition-all duration-300 hover:scale-[1.05] active:scale-[0.97] shadow-lg shadow-black/20"
            >
