...
import {
  ...
  Printer, BellRing, Check, Mail, MessageCircle, ShieldCheck
} from "lucide-react";
            ...
            <div className="rounded-[2rem] bg-gradient-to-br from-[#0F1F2E] to-[#1A3148] border border-white/5 p-8 md:p-10 shadow-xl shadow-ykay-green/5">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 rounded-full px-8 py-4 font-body text-sm font-bold tracking-[0.15em] transition-all ${
                    bulkStatus === "idle" ? "bg-ykay-green text-white hover:bg-ykay-green-dark hover:scale-[1.02] shadow-lg shadow-ykay-green-30" :
                      ...
                      <tr key={report.id} className="border-b border-ykay-navy-05 hover:bg-[#F5F7FA]/30 transition-colors">
                        ...
                        <td className="px-4 py-4">
                          <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold ${
                            report.status === "Released" ? "bg-ykay-green/10 text-ykay-green" : "bg-ykay-orange/10 text-ykay-orange"
                          }`}>
