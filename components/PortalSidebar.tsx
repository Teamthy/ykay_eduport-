    ...
    <aside className="lg:w-[280px] shrink-0">
      <div className="sticky top-24 space-y-4">
        <div className="rounded-2xl border border-white/10 bg-brand-navy p-4">
          <span className="text-[9px] font-bold uppercase tracking-widest text-brand-green">Active workspace</span>
          <div className="mt-1 font-display text-sm tracking-[1px] text-white">{portalName}</div>
          <div className="mt-1 text-[10px] uppercase tracking-widest text-white/50">{portalType}</div>
        </div>

        {user && (
          <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-card)] p-3">
            <div className="text-[10px] uppercase tracking-widest text-[var(--text-muted)]">Signed in</div>
