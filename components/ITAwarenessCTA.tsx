                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-white/70 text-lg font-body mb-8">
                            Join our internationally recognized IT training programs and earn certifications that open doors to global opportunities.
                            Our students have achieved remarkable success in Python, AI, Cybersecurity, and Microsoft Office applications.
                        </p>
                            ...
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                                {carouselImages.map((_, index) => (
                                    <button
                                        ...
                                        className={`w-3 h-3 rounded-full transition-all ${index === currentIndex ? 'bg-brand-green' : 'bg-white/30'
                                            }`}
                                    />
                                ))}
                            </div>
